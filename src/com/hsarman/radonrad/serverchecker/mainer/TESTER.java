...
public class TESTER implements Runnable {
	...
	public static void starttest() {
        ...
        logger.log(Level.INFO,"Initializing System...");
        ...
        logger.log(Level.INFO,"Checking computer system...");
        printComputerSystem(hal.getComputerSystem());

        logger.log(Level.INFO,"Checking Processor...");
        printProcessor(hal.getProcessor());

        logger.log(Level.INFO,"Checking Memory...");
        printMemory(hal.getMemory());

        logger.log(Level.INFO,"Checking CPU...");
        printCpu(hal.getProcessor());

        logger.log(Level.INFO,"Checking Processes...");
        printProcesses(os, hal.getMemory());

        logger.log(Level.INFO,"Checking Sensors...");
        printSensors(hal.getSensors());

        logger.log(Level.INFO,"Checking Power sources...");
        printPowerSources(hal.getPowerSources());

        logger.log(Level.INFO,"Checking Disks...");
        printDisks(hal.getDiskStores());

        logger.log(Level.INFO,"Checking File System...");
        printFileSystem(os.getFileSystem());

        logger.log(Level.INFO,"Checking Network interfaces...");
        printNetworkInterfaces(hal.getNetworkIFs());

        logger.log(Level.INFO,"Checking Network parameterss...");
        printNetworkParameters(os.getNetworkParams());

        // hardware: displays
        logger.log(Level.INFO,"Checking Displays...");
        printDisplays(hal.getDisplays());

        // hardware: USB devices
        logger.log(Level.INFO,"Checking USB Devices...");
